...
```sh
SHOT_DIR=docs/review-evidence/issue-43/nominal godot --path game \
  --rendering-driver opengl3 --resolution 1600x900 res://tests/screenshot_screens.tscn
TEAM_ALERT_CAPTURE=1 SHOT_DIR=docs/review-evidence/issue-43/alerte godot --path game \
  --rendering-driver opengl3 --resolution 1600x900 res://tests/screenshot_screens.tscn
```
...
Confiance : le panneau doit afficher « cherche ailleurs » et garder les quatre
critères dans le détail, plutôt que d'ajouter 28 nombres au HUD.
