...
- **Animations** — `UIHelpers.fade_in()` (arrivée en fondu sur chaque écran) et `UIHelpers.add_hover_bounce()` (léger zoom au survol des boutons). La preview d'impact au survol et l'impulsion animée à l'achat arrivent au lot 3 de la refonte.
